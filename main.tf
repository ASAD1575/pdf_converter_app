...
module "lambda_function" {
  ...
  # Layers
  libreoffice_layer_arn     = "arn:aws:lambda:us-east-1:764866452798:layer:libreoffice-gzip:1" # Ensure this is set to the correct ARN for your region and runtime
